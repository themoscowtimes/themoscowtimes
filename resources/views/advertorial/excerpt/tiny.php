...
<div class="<?php view::attr($bem()) ?>">
	<a href="<?php view::route('article', $item->data()); ?>" title="<?php view::text($item['title']) ?>">
		<?php if(! isset($time) || $time): ?>
			<time class="<?php view::attr($bem('time')) ?>  "  datetime="<?php view::text(date('c', strtotime($item->time_publication))); ?>" y-use="Timeago" >
