<div class="article__newsletter">
	...
	<div y-use="Newsletter" data-url="<?php view::route('newsletter'); ?>" id="newsletter">
		...
		<?php /*
		<select y-name="country" class="mb-1">
		...
		<select name="age" id="age" class="mb-1">
			<option value="age">Age (Optional)</option>
		...
		*/ ?>
		...
		<div class="" style="color: #ed1845; margin-top: 12px;" y-name="error" style="display:none"></div>
