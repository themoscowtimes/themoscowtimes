...
<rss xmlns:atom="http://www.w3.org/2005/Atom" version="2.0">
	<channel>
		...
		<link><?php view::url('base');?>rss/telegram</link>
		...
		<atom:link rel="self" href="<?php view::url('base')?>rss/telegram"></atom:link>
				...
				<?php foreach($item->body as $index => $block): ?>
					<?php if($block['type'] == 'html' && !empty($block['body'])): ?>
						<?php
							...
							$stripped = strip_tags(html_entity_decode($pieces[0]), '<p> <h1> <h2> <h3> <h4>');	
